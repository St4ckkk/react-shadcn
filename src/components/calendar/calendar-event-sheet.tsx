...
const CalendarEventSheet = ({ isOpen, onClose, onSave, editingEvent, selectedDate, isMobile = false }: CalendarEventSheetProps) => {
  ...
  return (
    <Sheet open={isOpen} onOpenChange={onClose}>
      <SheetContent side="right" className={`${isMobile ? 'w-[70vw]' : 'w-96'} p-0`}>
