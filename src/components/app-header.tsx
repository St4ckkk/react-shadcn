      ...
      <header className="flex h-16 shrink-0 items-center gap-4 border-b px-4">
        ...
        {!isMobile && (
          <div className="relative w-64">
            ...
            <Input
              ...
              className="pl-10 pr-16 h-9 rounded-sm"
            />
        ...
        <div className="flex items-center gap-2">
          <Popover>
            ...
            <PopoverContent className={`${isMobile ? 'w-72' : 'w-80'} p-0`} align="end">
          ...
          <Popover>
            ...
            <PopoverContent className={`${isMobile ? 'w-56' : 'w-64'} p-0`} align="end">
